...
const advantages = [
  {
    ...
    title: 'Innovation',
    text: 'Harnessing AI, satellites, robotics, and cloud solutions to create transformative outcomes for families and enterprises.'
  },
  {
    icon: '/assets/icon-rocket.svg',
    title: 'Speed',
    text: 'Accelerating time to value with agile, efficient delivery that turns bold visions into reality—faster.'
  },
  {
    icon: '/assets/icon-chart.svg',
    title: 'Scale',
    text: 'Delivering transformative solutions at massive scale—serving millions of people, impacting industries worth trillions in market capitalization, and mobilizing global resources and expertise to turn ambitious visions into reality.'
  },
  {
    icon: '/assets/icon-shield.svg',
    title: 'Trust',
    text: 'Building deep, strategic relationships that ensure transparency, accountability, and reliable results.'
  },
  {
    icon: '/assets/icon-ownership.svg',
    title: 'Ownership',
    text: 'Taking end-to-end responsibility for outcomes, orchestrating complex ecosystems so families can focus on growth and legacy.'
  },
  {
    icon: '/assets/icon-global.svg',
    title: 'Impact',
    text: 'Driving enduring societal, economic, and community benefits through technology, innovation, and responsible leadership.'
  }
]
      ...
      <section className="section-navy">
        <div className="base-container">
          <div className={styles.introText}>
            ...
            <p className={styles.introPara}>Unified Digital Group (UDG) empowers the world's most influential families to drive lasting societal impact through large-scale digital and economic transformation of their legacy.</p>
          </div>
        </div>
      </section>

      {/* Who We Serve — Light Grey */}
      <section className="section-grey">
        <div className="base-container">
          <div className="two-col">
            <div className="two-col-text">
              <p>We partner exclusively with the world's most visionary, multi-generational families—leaders who shape industries, drive global innovation, and cultivate enduring legacies. Our clients are not just focused on financial success—they are committed to co-creating ventures, sharing resources, and leveraging long-term relationships to generate lasting benefits for society, all while strengthening their family legacy and global reach.</p>
              <p><strong>With the right strategy, technology, and partners, no vision is too bold to bring to life.</strong></p>
            ...
            <div className="two-col-image">
              <img src="/assets/digital-transformation.jpg" alt="Digital Transformation" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-white">
        <div className="base-container">
          <div className="two-col reverse">
            ...
            <div className="two-col-image">
              <img src="/assets/innovation-article.jpg" alt="Innovation" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="base-container">
          <div className="two-col">
            <div className="two-col-text">
              ...
              <p><strong>One Vision. Unified Delivery.</strong></p>
            ...
            <div className="two-col-image">
              <img src="/assets/starlink.jpg" alt="Satellite connectivity" />
            </div>
          </div>
        </div>
      </section>
